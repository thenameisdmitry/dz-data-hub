...
**Audience:** anyone at DZ Software who needs database data
...
Access to DB datasets is granted through domain-scoped reader
...
**You need write access.** Database tables are never written to
